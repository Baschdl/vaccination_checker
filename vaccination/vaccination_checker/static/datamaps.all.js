  ...
  var defaultOptions = {
    ...
    geographyConfig: {
        ...
        popupTemplate: function(geography, data) {
          if (geography.properties.vaccs != null)
          {
            var a = geography.properties.vaccs;
            var b = a.split(',');
            var c = ''
            ...
            return '<div class="hoverinfo"><div><strong>' + geography.properties.name + '</strong></div><div>' + c + '</div>';
          }
          else
          {
    ...
    "objects": {
        "world": {
            ...
            "geometries": [{
                ...
                "properties": {
                    "name": "Germany",
                    "vaccs": "Routine vaccines, Hepatitis A, Hepatitis B, Rabies"
                },
                "id": "DEU",
                "arcs": [
